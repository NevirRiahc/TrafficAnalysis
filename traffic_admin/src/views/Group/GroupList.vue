<template>
  <div>
    ...
    <div class="header-menu">
      <el-input placeholder="SEARCH工会" v-model="keyword" @clear="inputListener" clearable>
    ...
    <!-- 弹出表单EDIT用户 -->
    <el-dialog title="EDIT工会" :visible.sync="visibleForm">
      <el-form
        :model="editFormData"
        label-position="left"
        label-width="80px"
    ...
    <el-dialog title="ADD工会" :visible.sync="visibleAddForm">
      <el-form
              :model="addFormdata"
              label-position="left"
              label-width="80px"
