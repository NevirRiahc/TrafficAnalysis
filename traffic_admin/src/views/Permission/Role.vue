    ...
    <el-table :data="rolesList" style="width: 100%;margin-top:30px;" border>
      ...
      <el-table-column align="center" label="操作">
        <template slot-scope="scope">
          ...
          <el-button type="danger" disabled size="small" @click="handleDelete(scope)">DEL</el-button>
        </template>
      </el-table-column>
    </el-table>

    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='edit'?'EDIT 角色':'新增 角色'">
