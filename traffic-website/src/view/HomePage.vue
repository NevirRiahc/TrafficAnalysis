    ...
    <div id="bigData" class="container-fuild">
      <div class="row bigData-container">
        <div class="col-xs-12 col-sm-12 col-md-6 wow zoomIn">
          <img class="img-responsive" src="@/assets/img/img1.png" alt="头号玩家">
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
          ...
          <p>ALL FROM INTERNET。</p>
<!--          <p>我们的流线式网页布局设计方案和可视化图文内容编辑模式让网站制作和维护成为一件轻松惬意的事。无论您是普通互联网用户，还是专业网站制作人员。</p>-->
          <h2 class="bigData-device">PC/PAD/Phone &nbsp; ALL PLATFORM</h2>
          <a href="#" class="btn btn-lg btn-block btn-info">USER </a>
        </div>
      </div>
    </div>
    <!-- 您身边的IT专家 -->
    ...
    <!-- 为什么选择我们 -->
    <div id="whyChooseUs" class="conatiner-fuild" style="display: none;">
      <div class="container">
      ...
      serverList: [
        {
          ...
          title: "核心优势1",
          content: "<p>由专业客服提供人工服务</p>负责安装部署"
        },
        {
          logo: require("@/assets/img/computer.png"),
          title: "核心优势2",
          content: "<p>利用远程视频工具，提供协助</p>帮助客户进行陪玩"
        },
        {
          logo: require("@/assets/img/qq.png"),
          title: "核心优势3",
          content: "<p>利用线下要点提供技术</p>帮助打金"
        },
        {
          logo: require("@/assets/img/skill.png"),
          title: "核心优势4",
          content: "<p>由上百位专家</p>帮助快速代练"
        }
      ]
    };
  },
